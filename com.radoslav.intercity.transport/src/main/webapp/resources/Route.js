com.intercity.Route = function() {};

com.intercity.Route.prototype.loadContent = function() {
...
com.intercity.Route.prototype._addForm = function(container) {
	$(container).append(
		"<div align='center'>" +
			"<p>Регистрирайте вашите маршрути : </p>" +
...
com.intercity.Route.prototype._addFormListener = function() {
	$(".route-registration-form").submit(function(oEvent) {
		alert('Hello From Route');
